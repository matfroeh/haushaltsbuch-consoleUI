 ...
 * der User keine negative Gleitkommazahlen (die Zahl 0 ist exkludiert)
 * eingeben haben.
 * So mit kann im {@link de.rhistel.logic.ConsoleReader}
 * die Fehler deutlicher und besser abgefangen werden.
 */
public class NoNegativeDoubleException extends  Exception{
	 ...
	 * {@link Texts#USER_MSG_NOT_A_NEGATIVE_DOUBLE_TRY_AGAIN}
	 */
	public NoNegativeDoubleException() {
		super(Texts.USER_MSG_NOT_A_NEGATIVE_DOUBLE_TRY_AGAIN);
	}
