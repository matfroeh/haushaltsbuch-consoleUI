 ...
 * der User keine positive Gleitkommazahlen (die Zahl 0 ist inkludiert)
 * eingeben haben.
 * So mit kann im {@link de.rhistel.logic.ConsoleReader}
 * die Fehler deutlicher und besser abgefangen werden.
 */
public class NoPositiveDoubleException extends Exception{
	 ...
	 * {@link Texts#USER_MSG_NOT_A_POSITIVE_DOUBLE_TRY_AGAIN}
	 */
	public NoPositiveDoubleException() {
		super(Texts.USER_MSG_NOT_A_POSITIVE_DOUBLE_TRY_AGAIN);
	}
